				...
				<form:form action="addComputer" method="POST"
					...
					<fieldset>
						<div class="form-group">
							<form:label for="computerName" path="name"><spring:message code="dashboard.name"/></form:label>
						...
						<div class="form-group">
							<form:label for="companyId" path="manufacturer"><spring:message code="dashboard.company"/></form:label>
					...
					<div class="actions pull-right">
						<input type="submit" value="<spring:message code="dashboard.add2"/>" class="btn btn-primary">
